package com.unir.back_end_inventory_books_elasticsearch.config;
...
@Configuration
@EnableElasticsearchRepositories(basePackages = "com.unir.back_end_inventory_books_elasticsearch.data")
